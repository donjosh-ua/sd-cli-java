...
//         User user = userService.findByEmail(expenseRequest.getUser().getEmail())
//                 .orElseThrow(() -> new IllegalArgumentException("User not found with email: " + expenseRequest.getUser().getEmail()));
