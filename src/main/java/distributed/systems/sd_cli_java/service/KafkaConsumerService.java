...
//                     notification.getNickname(), notification.getPlanId());

//             // Validate required fields
//             if (notification.getPlanId() == null || notification.getNickname() == null) {
//                 log.warn("Cannot process join plan request: missing nickname or planId");
//                 return;
//             }

//             // Call the plan service to add user to plan
//             boolean success = planService.addUserToPlanByNickname(
...
//                     registration.getNickname(), registration.getPlanId());
...
//             // Validate required fields
//             if (registration.getPlanId() == null || registration.getNickname() == null
...
//             User user = userService.findOrCreateByNickname(registration.getNickname());
...
//             if (!userInPlan) {
//                 log.info("User {} is not part of plan {}, adding user to plan", user.getNickname(), plan.getName());
...
//                     savedExpense.getExpenseId(), savedExpense.getAmount(), user.getNickname(), plan.getName());
