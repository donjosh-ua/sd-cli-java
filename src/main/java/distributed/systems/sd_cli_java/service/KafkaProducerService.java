...
// import
// distributed.systems.sd_cli_java.model.dto.ExpenseCreatedNotificationDTO;
...
// float sharePerUser = userCount > 0 ? totalPlanExpense / userCount :
// totalPlanExpense;

// ExpenseCreatedNotificationDTO notification =
// ExpenseCreatedNotificationDTO.builder()
...
// } else {
// log.error("Failed to send notification to topic {}: {}", topicName,
// ex.getMessage(), ex);
// }
// });
// }
